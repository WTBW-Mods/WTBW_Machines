package com.wtbw.mods.machines.event;
...
public class WitherEvents
{
  ...
  {
    if (event.getEntityLiving() instanceof WitherEntity || event.getEntity() instanceof WitherSkullEntity && event.getState().getBlock() == ModBlocks.DARK_CRYSTAL_BLOCK)
    {
